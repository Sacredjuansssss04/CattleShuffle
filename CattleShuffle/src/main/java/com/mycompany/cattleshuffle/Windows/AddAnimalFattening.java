...
public class AddAnimalFattening extends javax.swing.JFrame {
    ...
    public static final Path FATTENING_PATH = Paths.get("data/animals/fattening.json");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar nuevo animal de engorde");
        ...
        animalSpecie.setBackground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 430, 340));
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try{
            ...
            AnimalFattening animal = new AnimalFattening(0, 0, "none", "none", "none", (int)0, "none", "none", "none", 0);
            animal.setName(name);
            ...
            List<AnimalFattening> fattening = FileManager.loadFattening(FATTENING_PATH);
            fattening.add(animal);
            FileManager.saveFattening(fattening, FATTENING_PATH);
